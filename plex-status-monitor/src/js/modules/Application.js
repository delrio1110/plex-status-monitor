...
export default React.createClass({
  ...
  render: function() {
    ...
    if (!this.state.loggedIn) {
      login = <LoginForm addPlexData={this.addPlexData} updateUserState={this.updateUserState} updateUserIP={this.updateUserIP} serverInterval={this.state.serverInterval} loggedIn={this.state.loggedIn} updateUserCount={this.updateUserCount}/>
    }
